...
80100b71:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
...
80100c20:	e8 4b 1f 00 00       	call   80102b70 <end_op>
    cprintf("exec: fail\n");
80100c25:	c7 04 24 e1 6e 10 80 	movl   $0x80106ee1,(%esp)
...
80100c7d:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c83:	e8 b8 60 00 00       	call   80106d40 <copyout>
...
80100cca:	83 c0 70             	add    $0x70,%eax
...
80100cf0:	8b 47 1c             	mov    0x1c(%edi),%eax
  curproc->pgdir = pgdir;
...
80100d08:	e8 43 59 00 00       	call   80106650 <switchuvm>
  freevm(oldpgdir);
80100d0d:	89 34 24             	mov    %esi,(%esp)
80100d10:	e8 bb 5c 00 00       	call   801069d0 <freevm>
  return 0;
...
80100d36:	c7 44 24 04 ed 6e 10 	movl   $0x80106eed,0x4(%esp)
80100d3d:	80 
...
80100df6:	c3                   	ret    
    panic("filedup");
80100df7:	c7 04 24 f4 6e 10 80 	movl   $0x80106ef4,(%esp)
...
80100eb7:	e9 b4 1c 00 00       	jmp    80102b70 <end_op>
    panic("fileclose");
80100ebc:	c7 04 24 fc 6e 10 80 	movl   $0x80106efc,(%esp)
...
80100fa5:	eb d8                	jmp    80100f7f <fileread+0x5f>
  panic("fileread");
80100fa7:	c7 04 24 06 6f 10 80 	movl   $0x80106f06,(%esp)
...
801010bc:	e9 1f 22 00 00       	jmp    801032e0 <pipewrite>
        panic("short filewrite");
801010c1:	c7 04 24 0f 6f 10 80 	movl   $0x80106f0f,(%esp)
801010c8:	e8 93 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010cd:	c7 04 24 15 6f 10 80 	movl   $0x80106f15,(%esp)
...
801012ad:	c7 04 24 35 6f 10 80 	movl   $0x80106f35,(%esp)
...
80101365:	eb 93                	jmp    801012fa <bmap+0x3a>
  panic("bmap: out of range");
80101367:	c7 04 24 45 6f 10 80 	movl   $0x80106f45,(%esp)
...
80101449:	c7 04 24 58 6f 10 80 	movl   $0x80106f58,(%esp)
...
8010146c:	c7 44 24 04 6b 6f 10 	movl   $0x80106f6b,0x4(%esp)
80101473:	80 
...
80101489:	c7 44 24 04 72 6f 10 	movl   $0x80106f72,0x4(%esp)
80101490:	80 
...
801014b6:	c7 04 24 d8 6f 10 80 	movl   $0x80106fd8,(%esp)
...
801015d1:	c7 04 24 78 6f 10 80 	movl   $0x80106f78,(%esp)
...
80101754:	0f 85 76 ff ff ff    	jne    801016d0 <ilock+0x30>
      panic("ilock: no type");
8010175a:	c7 04 24 90 6f 10 80 	movl   $0x80106f90,(%esp)
80101761:	e8 fa eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101766:	c7 04 24 8a 6f 10 80 	movl   $0x80106f8a,(%esp)
...
801017ae:	e9 1d 28 00 00       	jmp    80103fd0 <releasesleep>
    panic("iunlock");
801017b3:	c7 04 24 9f 6f 10 80 	movl   $0x80106f9f,(%esp)
...
80101c51:	c3                   	ret    
      panic("dirlookup read");
80101c52:	c7 04 24 b9 6f 10 80 	movl   $0x80106fb9,(%esp)
80101c59:	e8 02 e7 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c5e:	c7 04 24 a7 6f 10 80 	movl   $0x80106fa7,(%esp)
...
80101ed3:	eb e9                	jmp    80101ebe <dirlink+0xae>
      panic("dirlink read");
80101ed5:	c7 04 24 c8 6f 10 80 	movl   $0x80106fc8,(%esp)
80101edc:	e8 7f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ee1:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
...
80101fcf:	c7 04 24 34 70 10 80 	movl   $0x80107034,(%esp)
80101fd6:	e8 85 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101fdb:	c7 04 24 2b 70 10 80 	movl   $0x8010702b,(%esp)
...
80101ff6:	c7 44 24 04 46 70 10 	movl   $0x80107046,0x4(%esp)
80101ffd:	80 
...
801021c9:	eb bb                	jmp    80102186 <iderw+0x76>
    panic("iderw: buf not locked");
801021cb:	c7 04 24 4a 70 10 80 	movl   $0x8010704a,(%esp)
801021d2:	e8 89 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021d7:	c7 04 24 75 70 10 80 	movl   $0x80107075,(%esp)
801021de:	e8 7d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021e3:	c7 04 24 60 70 10 80 	movl   $0x80107060,(%esp)
...
80102238:	c7 04 24 94 70 10 80 	movl   $0x80107094,(%esp)
...
8010236c:	eb bb                	jmp    80102329 <kfree+0x49>
    panic("kfree");
8010236e:	c7 04 24 c6 70 10 80 	movl   $0x801070c6,(%esp)
...
801023db:	c7 44 24 04 cc 70 10 	movl   $0x801070cc,0x4(%esp)
801023e2:	80 
...
80102524:	0f b6 81 00 72 10 80 	movzbl -0x7fef8e00(%ecx),%eax
...
80102558:	0f b6 91 00 72 10 80 	movzbl -0x7fef8e00(%ecx),%edx
  shift ^= togglecode[data];
8010255f:	0f b6 81 00 71 10 80 	movzbl -0x7fef8f00(%ecx),%eax
  shift |= shiftcode[data];
...
8010256f:	8b 04 85 e0 70 10 80 	mov    -0x7fef8f20(,%eax,4),%eax
  shift ^= togglecode[data];
...
80102a6b:	c7 44 24 04 00 73 10 	movl   $0x80107300,0x4(%esp)
80102a72:	80 
...
80102c92:	c3                   	ret    
    panic("log.committing");
80102c93:	c7 04 24 04 73 10 80 	movl   $0x80107304,(%esp)
...
80102d4d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d50:	c7 04 24 13 73 10 80 	movl   $0x80107313,(%esp)
80102d57:	e8 04 d6 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d5c:	c7 04 24 29 73 10 80 	movl   $0x80107329,(%esp)
...
80102d87:	c7 04 24 44 73 10 80 	movl   $0x80107344,(%esp)
...
80102e35:	e8 96 3f 00 00       	call   80106dd0 <shminit>
  tvinit();        // trap vectors
...
80102f2f:	00 
80102f30:	c7 44 24 04 58 73 10 	movl   $0x80107358,0x4(%esp)
80102f37:	80 
...
80102fea:	00 
80102feb:	c7 44 24 04 5d 73 10 	movl   $0x8010735d,0x4(%esp)
80102ff2:	80 
...
8010307c:	ff 24 8d 9c 73 10 80 	jmp    *-0x7fef8c64(,%ecx,4)
80103083:	90                   	nop
...
80103107:	0f 85 c5 fe ff ff    	jne    80102fd2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010310d:	c7 04 24 62 73 10 80 	movl   $0x80107362,(%esp)
...
80103128:	eb e3                	jmp    8010310d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010312a:	c7 04 24 7c 73 10 80 	movl   $0x8010737c,(%esp)
...
801031cf:	c7 44 24 04 b0 73 10 	movl   $0x801073b0,0x4(%esp)
801031d6:	80 
...
801035d6:	c7 44 24 04 b5 73 10 	movl   $0x801073b5,0x4(%esp)
801035dd:	80 
...
8010364a:	c7 04 24 bc 73 10 80 	movl   $0x801073bc,(%esp)
80103651:	e8 0a cd ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103656:	c7 04 24 98 74 10 80 	movl   $0x80107498,(%esp)
...
80103772:	00 
80103773:	c7 44 24 04 e5 73 10 	movl   $0x801073e5,0x4(%esp)
8010377a:	80 
8010377b:	89 04 24             	mov    %eax,(%esp)
8010377e:	e8 cd 0c 00 00       	call   80104450 <safestrcpy>
  p->cwd = namei("/");
80103783:	c7 04 24 ee 73 10 80 	movl   $0x801073ee,(%esp)
...
801037b7:	c7 04 24 cc 73 10 80 	movl   $0x801073cc,(%esp)
...
8010386e:	e8 bd 32 00 00       	call   80106b30 <copyuvm>
...
80103888:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
8010388a:	8b 7a 1c             	mov    0x1c(%edx),%edi
  np->parent = curproc;
8010388d:	89 5a 18             	mov    %ebx,0x18(%edx)
  *np->tf = *curproc->tf;
80103890:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103893:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103895:	31 f6                	xor    %esi,%esi
  np->stack_pages = curproc->stack_pages;
80103897:	8b 43 0c             	mov    0xc(%ebx),%eax
8010389a:	89 42 0c             	mov    %eax,0xc(%edx)
  np->tf->eax = 0;
8010389d:	8b 42 1c             	mov    0x1c(%edx),%eax
801038a0:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
801038a7:	90                   	nop
    if(curproc->ofile[i])
801038a8:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
...
80103938:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    np->state = UNUSED;
8010393f:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
    return -1;
...
801039a2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039a5:	e8 a6 2c 00 00       	call   80106650 <switchuvm>
...
801039bb:	e8 eb 0a 00 00       	call   801044ab <swtch>
      switchkvm();
801039c0:	e8 6b 2c 00 00       	call   80106630 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103a5e:	c7 04 24 f0 73 10 80 	movl   $0x801073f0,(%esp)
80103a65:	e8 f6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a6a:	c7 04 24 1c 74 10 80 	movl   $0x8010741c,(%esp)
80103a71:	e8 ea c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a76:	c7 04 24 0e 74 10 80 	movl   $0x8010740e,(%esp)
80103a7d:	e8 de c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a82:	c7 04 24 02 74 10 80 	movl   $0x80107402,(%esp)
...
80103b86:	e8 65 fe ff ff       	call   801039f0 <sched>
  panic("zombie exit");
80103b8b:	c7 04 24 3d 74 10 80 	movl   $0x8010743d,(%esp)
80103b92:	e8 c9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103b97:	c7 04 24 30 74 10 80 	movl   $0x80107430,(%esp)
...
80103c7e:	c7 04 24 4f 74 10 80 	movl   $0x8010744f,(%esp)
80103c85:	e8 d6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c8a:	c7 04 24 49 74 10 80 	movl   $0x80107449,(%esp)
...
80103d28:	e8 a3 2c 00 00       	call   801069d0 <freevm>
        release(&ptable.lock);
...
80103e74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e78:	c7 04 24 8b 78 10 80 	movl   $0x8010788b,(%esp)
...
80103e9a:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103e9d:	ba 60 74 10 80       	mov    $0x80107460,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103ea2:	77 11                	ja     80103eb5 <procdump+0x55>
80103ea4:	8b 14 85 c0 74 10 80 	mov    -0x7fef8b40(,%eax,4),%edx
      state = "???";
80103eab:	b8 60 74 10 80       	mov    $0x80107460,%eax
...
80103ec0:	c7 04 24 64 74 10 80 	movl   $0x80107464,(%esp)
...
80103f09:	c7 04 24 a1 6e 10 80 	movl   $0x80106ea1,(%esp)
...
80103f3a:	c7 44 24 04 d8 74 10 	movl   $0x801074d8,0x4(%esp)
80103f41:	80 
...
80104197:	eb ac                	jmp    80104145 <acquire+0x15>
    panic("acquire");
80104199:	c7 04 24 e3 74 10 80 	movl   $0x801074e3,(%esp)
...
801041f9:	c3                   	ret    
    panic("popcli");
801041fa:	c7 04 24 02 75 10 80 	movl   $0x80107502,(%esp)
80104201:	e8 5a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104206:	c7 04 24 eb 74 10 80 	movl   $0x801074eb,(%esp)
...
8010422f:	75 0f                	jne    80104240 <release+0x20>
    panic("release");
80104231:	c7 04 24 09 75 10 80 	movl   $0x80107509,(%esp)
...
8010462d:	8b 14 85 40 75 10 80 	mov    -0x7fef8ac0(,%eax,4),%edx
...
80104656:	c7 04 24 11 75 10 80 	movl   $0x80107511,(%esp)
...
801047e0:	c7 44 24 04 bc 75 10 	movl   $0x801075bc,0x4(%esp)
801047e7:	80 
...
801047fb:	c7 44 24 04 bb 75 10 	movl   $0x801075bb,0x4(%esp)
80104802:	80 
...
80104811:	79 89                	jns    8010479c <create+0xdc>
      panic("create dots");
80104813:	c7 04 24 af 75 10 80 	movl   $0x801075af,(%esp)
8010481a:	e8 41 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010481f:	c7 04 24 be 75 10 80 	movl   $0x801075be,(%esp)
80104826:	e8 35 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010482b:	c7 04 24 a0 75 10 80 	movl   $0x801075a0,(%esp)
...
80104bd1:	c7 44 24 04 bc 75 10 	movl   $0x801075bc,0x4(%esp)
80104bd8:	80 
...
80104be9:	c7 44 24 04 bb 75 10 	movl   $0x801075bb,0x4(%esp)
80104bf0:	80 
...
80104d3d:	c7 04 24 e0 75 10 80 	movl   $0x801075e0,(%esp)
80104d44:	e8 17 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d49:	c7 04 24 f2 75 10 80 	movl   $0x801075f2,(%esp)
80104d50:	e8 0b b6 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d55:	c7 04 24 ce 75 10 80 	movl   $0x801075ce,(%esp)
...
80105209:	e8 22 1c 00 00       	call   80106e30 <shm_open>
}
8010520e:	c9                   	leave  
8010520f:	c3                   	ret    
    return -1;
...
80105243:	e8 f8 1b 00 00       	call   80106e40 <shm_close>
}
80105248:	c9                   	leave  
80105249:	c3                   	ret    
...
80105489:	c7 44 24 04 01 76 10 	movl   $0x80107601,0x4(%esp)
80105490:	80 
...
80105512:	0f 84 10 02 00 00    	je     80105728 <trap+0x228>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105520:	ff 24 85 0c 77 10 80 	jmp    *-0x7fef88f4(,%eax,4)
80105527:	90                   	nop
    break;
...
8010552f:	90                   	nop
80105530:	0f 84 98 02 00 00    	je     801057ce <trap+0x2ce>
80105536:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010553a:	0f 84 8e 02 00 00    	je     801057ce <trap+0x2ce>
...
8010557e:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
            myproc()->pid, myproc()->name, tf->trapno,
...
80105588:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010558c:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80105590:	8b 40 14             	mov    0x14(%eax),%eax
80105593:	c7 04 24 c8 76 10 80 	movl   $0x801076c8,(%esp)
...
801055fb:	0f 84 58 01 00 00    	je     80105759 <trap+0x259>
    exit();
}
...
80105640:	0f 20 d6             	mov    %cr2,%esi
    if (f >KERNBASE-1){
80105643:	85 f6                	test   %esi,%esi
80105645:	0f 88 6d 01 00 00    	js     801057b8 <trap+0x2b8>
8010564b:	90                   	nop
8010564c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (allocuvm(myproc()->pgdir, f, f + PGSIZE) == 0) {
80105650:	e8 3b e0 ff ff       	call   80103690 <myproc>
    f = PGROUNDDOWN(f);
80105655:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if (allocuvm(myproc()->pgdir, f, f + PGSIZE) == 0) {
8010565b:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
80105661:	89 54 24 08          	mov    %edx,0x8(%esp)
80105665:	89 74 24 04          	mov    %esi,0x4(%esp)
80105669:	8b 40 04             	mov    0x4(%eax),%eax
8010566c:	89 04 24             	mov    %eax,(%esp)
8010566f:	e8 3c 12 00 00       	call   801068b0 <allocuvm>
80105674:	85 c0                	test   %eax,%eax
80105676:	0f 84 24 01 00 00    	je     801057a0 <trap+0x2a0>
    myproc()->stack_pages++;
8010567c:	e8 0f e0 ff ff       	call   80103690 <myproc>
80105681:	83 40 0c 01          	addl   $0x1,0xc(%eax)
    cprintf("Increased Stack Size, Number of pages allocated: %d\n", myproc()->stack_pages);
80105685:	e8 06 e0 ff ff       	call   80103690 <myproc>
8010568a:	8b 40 0c             	mov    0xc(%eax),%eax
8010568d:	c7 04 24 5c 76 10 80 	movl   $0x8010765c,(%esp)
80105694:	89 44 24 04          	mov    %eax,0x4(%esp)
80105698:	e8 b3 af ff ff       	call   80100650 <cprintf>
    break;
8010569d:	e9 0e ff ff ff       	jmp    801055b0 <trap+0xb0>
801056a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801056a8:	e8 c3 df ff ff       	call   80103670 <cpuid>
801056ad:	85 c0                	test   %eax,%eax
801056af:	90                   	nop
801056b0:	0f 84 ba 00 00 00    	je     80105770 <trap+0x270>
    lapiceoi();
801056b6:	e8 b5 d0 ff ff       	call   80102770 <lapiceoi>
801056bb:	90                   	nop
801056bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    break;
801056c0:	e9 eb fe ff ff       	jmp    801055b0 <trap+0xb0>
801056c5:	8d 76 00             	lea    0x0(%esi),%esi
801056c8:	90                   	nop
801056c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801056d0:	e8 eb ce ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
801056d5:	e8 96 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056da:	e9 d1 fe ff ff       	jmp    801055b0 <trap+0xb0>
801056df:	90                   	nop
    uartintr();
...
801056e5:	e8 86 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056ea:	e9 c1 fe ff ff       	jmp    801055b0 <trap+0xb0>
801056ef:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801056f0:	8b 7b 38             	mov    0x38(%ebx),%edi
801056f3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801056f7:	e8 74 df ff ff       	call   80103670 <cpuid>
801056fc:	c7 04 24 38 76 10 80 	movl   $0x80107638,(%esp)
...
8010570f:	e8 3c af ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105714:	e8 57 d0 ff ff       	call   80102770 <lapiceoi>
    break;
80105719:	e9 92 fe ff ff       	jmp    801055b0 <trap+0xb0>
8010571e:	66 90                	xchg   %ax,%ax
    ideintr();
80105720:	e8 4b c9 ff ff       	call   80102070 <ideintr>
80105725:	eb 8f                	jmp    801056b6 <trap+0x1b6>
80105727:	90                   	nop
80105728:	90                   	nop
80105729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105730:	e8 5b df ff ff       	call   80103690 <myproc>
80105735:	8b 70 28             	mov    0x28(%eax),%esi
80105738:	85 f6                	test   %esi,%esi
8010573a:	75 2c                	jne    80105768 <trap+0x268>
    myproc()->tf = tf;
8010573c:	e8 4f df ff ff       	call   80103690 <myproc>
80105741:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105744:	e8 c7 ee ff ff       	call   80104610 <syscall>
    if(myproc()->killed)
80105749:	e8 42 df ff ff       	call   80103690 <myproc>
8010574e:	8b 48 28             	mov    0x28(%eax),%ecx
80105751:	85 c9                	test   %ecx,%ecx
80105753:	0f 84 a8 fe ff ff    	je     80105601 <trap+0x101>
}
...
8010575f:	5d                   	pop    %ebp
      exit();
80105760:	e9 2b e3 ff ff       	jmp    80103a90 <exit>
80105765:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105768:	e8 23 e3 ff ff       	call   80103a90 <exit>
8010576d:	eb cd                	jmp    8010573c <trap+0x23c>
8010576f:	90                   	nop
      acquire(&tickslock);
80105770:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105777:	e8 b4 e9 ff ff       	call   80104130 <acquire>
      wakeup(&ticks);
8010577c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105783:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010578a:	e8 f1 e5 ff ff       	call   80103d80 <wakeup>
      release(&tickslock);
8010578f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105796:	e8 85 ea ff ff       	call   80104220 <release>
8010579b:	e9 16 ff ff ff       	jmp    801056b6 <trap+0x1b6>
        cprintf("allocuvm fail");
801057a0:	c7 04 24 22 76 10 80 	movl   $0x80107622,(%esp)
801057a7:	e8 a4 ae ff ff       	call   80100650 <cprintf>
        exit();
801057ac:	e8 df e2 ff ff       	call   80103a90 <exit>
801057b1:	e9 c6 fe ff ff       	jmp    8010567c <trap+0x17c>
801057b6:	66 90                	xchg   %ax,%ax
        cprintf("from trap access > KERNBASE");
801057b8:	c7 04 24 06 76 10 80 	movl   $0x80107606,(%esp)
801057bf:	e8 8c ae ff ff       	call   80100650 <cprintf>
        exit();
801057c4:	e8 c7 e2 ff ff       	call   80103a90 <exit>
801057c9:	e9 7d fe ff ff       	jmp    8010564b <trap+0x14b>
801057ce:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057d1:	8b 73 38             	mov    0x38(%ebx),%esi
801057d4:	e8 97 de ff ff       	call   80103670 <cpuid>
801057d9:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057dd:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057e1:	89 44 24 08          	mov    %eax,0x8(%esp)
801057e5:	8b 43 30             	mov    0x30(%ebx),%eax
801057e8:	c7 04 24 94 76 10 80 	movl   $0x80107694,(%esp)
801057ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801057f3:	e8 58 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057f8:	c7 04 24 30 76 10 80 	movl   $0x80107630,(%esp)
801057ff:	e8 5c ab ff ff       	call   80100360 <panic>
...
801058f7:	00 
  for(p="xv6...\n"; *p; p++)
801058f8:	bb d4 77 10 80       	mov    $0x801077d4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106422:	e8 49 de ff ff       	call   80104270 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801064da:	c3                   	ret    
        panic("kfree");
801064db:	c7 04 24 c6 70 10 80 	movl   $0x801070c6,(%esp)
...
80106621:	c3                   	ret    
      panic("remap");
80106622:	c7 04 24 dc 77 10 80 	movl   $0x801077dc,(%esp)
80106629:	e8 32 9d ff ff       	call   80100360 <panic>
8010662e:	66 90                	xchg   %ax,%ax

80106630 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106630:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
80106674:	0f 84 c3 00 00 00    	je     8010673d <switchuvm+0xed>
  pushcli();
8010667a:	e8 71 da ff ff       	call   801040f0 <pushcli>
...
8010672b:	5d                   	pop    %ebp
  popcli();
8010672c:	e9 7f da ff ff       	jmp    801041b0 <popcli>
    panic("switchuvm: no process");
80106731:	c7 04 24 e2 77 10 80 	movl   $0x801077e2,(%esp)
80106738:	e8 23 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010673d:	c7 04 24 0d 78 10 80 	movl   $0x8010780d,(%esp)
80106744:	e8 17 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106749:	c7 04 24 f8 77 10 80 	movl   $0x801077f8,(%esp)
...
80106795:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106797:	e8 d4 da ff ff       	call   80104270 <memset>
...
801067d8:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801067d9:	e9 32 db ff ff       	jmp    80104310 <memmove>
    panic("inituvm: more than a page");
801067de:	c7 04 24 21 78 10 80 	movl   $0x80107821,(%esp)
...
80106892:	c7 04 24 3b 78 10 80 	movl   $0x8010783b,(%esp)
80106899:	e8 c2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010689e:	c7 04 24 dc 78 10 80 	movl   $0x801078dc,(%esp)
...
801068fb:	e8 70 d9 ff ff       	call   80104270 <memset>
...
80106942:	c7 04 24 59 78 10 80 	movl   $0x80107859,(%esp)
...
80106970:	c7 04 24 71 78 10 80 	movl   $0x80107871,(%esp)
...
80106a33:	e9 a8 b8 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106a38:	c7 04 24 8d 78 10 80 	movl   $0x8010788d,(%esp)
...
80106a7b:	e8 f0 d7 ff ff       	call   80104270 <memset>
...
80106aeb:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106b1b:	c3                   	ret    
    panic("clearpteu");
80106b1c:	c7 04 24 9e 78 10 80 	movl   $0x8010789e,(%esp)
...
80106b36:	83 ec 2c             	sub    $0x2c,%esp
  ...
  char *mem;
  struct proc *curproc = myproc();
80106b39:	e8 52 cb ff ff       	call   80103690 <myproc>
80106b3e:	89 45 dc             	mov    %eax,-0x24(%ebp)

  if((d = setupkvm()) == 0)
80106b41:	e8 0a ff ff ff       	call   80106a50 <setupkvm>
80106b46:	85 c0                	test   %eax,%eax
80106b48:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106b4b:	0f 84 8d 01 00 00    	je     80106cde <copyuvm+0x1ae>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b51:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b54:	85 c0                	test   %eax,%eax
80106b56:	0f 84 ac 00 00 00    	je     80106c08 <copyuvm+0xd8>
80106b5c:	31 db                	xor    %ebx,%ebx
80106b5e:	eb 51                	jmp    80106bb1 <copyuvm+0x81>
...
80106b60:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106b66:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b6d:	00 
80106b6e:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106b72:	89 04 24             	mov    %eax,(%esp)
80106b75:	e8 96 d7 ff ff       	call   80104310 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106b7a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b7d:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106b83:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106b87:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b8e:	00 
80106b8f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106b93:	89 44 24 10          	mov    %eax,0x10(%esp)
80106b97:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b9a:	89 04 24             	mov    %eax,(%esp)
80106b9d:	e8 0e fa ff ff       	call   801065b0 <mappages>
80106ba2:	85 c0                	test   %eax,%eax
80106ba4:	78 4d                	js     80106bf3 <copyuvm+0xc3>
  for(i = 0; i < sz; i += PGSIZE){
80106ba6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bac:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106baf:	76 57                	jbe    80106c08 <copyuvm+0xd8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106bb1:	8b 45 08             	mov    0x8(%ebp),%eax
80106bb4:	31 c9                	xor    %ecx,%ecx
80106bb6:	89 da                	mov    %ebx,%edx
80106bb8:	e8 03 f8 ff ff       	call   801063c0 <walkpgdir>
80106bbd:	85 c0                	test   %eax,%eax
80106bbf:	0f 84 2c 01 00 00    	je     80106cf1 <copyuvm+0x1c1>
    if(!(*pte & PTE_P))
80106bc5:	8b 30                	mov    (%eax),%esi
80106bc7:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bcd:	0f 84 12 01 00 00    	je     80106ce5 <copyuvm+0x1b5>
    pa = PTE_ADDR(*pte);
80106bd3:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106bd5:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106bdb:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106bde:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106be4:	e8 a7 b8 ff ff       	call   80102490 <kalloc>
80106be9:	85 c0                	test   %eax,%eax
80106beb:	89 c6                	mov    %eax,%esi
80106bed:	0f 85 6d ff ff ff    	jne    80106b60 <copyuvm+0x30>
    }
...
bad:
  freevm(d);
80106bf3:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106bf6:	89 04 24             	mov    %eax,(%esp)
80106bf9:	e8 d2 fd ff ff       	call   801069d0 <freevm>
  return 0;
80106bfe:	31 c0                	xor    %eax,%eax
}
80106c00:	83 c4 2c             	add    $0x2c,%esp
80106c03:	5b                   	pop    %ebx
80106c04:	5e                   	pop    %esi
80106c05:	5f                   	pop    %edi
80106c06:	5d                   	pop    %ebp
...
80106c08:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c0b:	8b 40 0c             	mov    0xc(%eax),%eax
80106c0e:	f7 d8                	neg    %eax
80106c10:	c1 e0 0c             	shl    $0xc,%eax
80106c13:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80106c18:	3d ff ef ff 7f       	cmp    $0x7fffefff,%eax
80106c1d:	0f 87 b0 00 00 00    	ja     80106cd3 <copyuvm+0x1a3>
80106c23:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80106c28:	eb 6a                	jmp    80106c94 <copyuvm+0x164>
...
80106c45:	e8 c6 d6 ff ff       	call   80104310 <memmove>
        if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106c4a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c4d:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106c53:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c57:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c5e:	00 
80106c5f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106c63:	89 44 24 10          	mov    %eax,0x10(%esp)
80106c67:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c6a:	89 04 24             	mov    %eax,(%esp)
80106c6d:	e8 3e f9 ff ff       	call   801065b0 <mappages>
80106c72:	85 c0                	test   %eax,%eax
80106c74:	0f 88 79 ff ff ff    	js     80106bf3 <copyuvm+0xc3>
    for(i = t; i > t - (curproc->stack_pages) * PGSIZE; i -= PGSIZE){
80106c7a:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c7d:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106c83:	8b 40 0c             	mov    0xc(%eax),%eax
80106c86:	f7 d8                	neg    %eax
80106c88:	c1 e0 0c             	shl    $0xc,%eax
80106c8b:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80106c90:	39 d8                	cmp    %ebx,%eax
80106c92:	73 3f                	jae    80106cd3 <copyuvm+0x1a3>
        if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c94:	8b 45 08             	mov    0x8(%ebp),%eax
80106c97:	31 c9                	xor    %ecx,%ecx
80106c99:	89 da                	mov    %ebx,%edx
80106c9b:	e8 20 f7 ff ff       	call   801063c0 <walkpgdir>
80106ca0:	85 c0                	test   %eax,%eax
80106ca2:	74 4d                	je     80106cf1 <copyuvm+0x1c1>
        if(!(*pte & PTE_P))
80106ca4:	8b 30                	mov    (%eax),%esi
80106ca6:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106cac:	74 37                	je     80106ce5 <copyuvm+0x1b5>
        pa = PTE_ADDR(*pte);
80106cae:	89 f7                	mov    %esi,%edi
        flags = PTE_FLAGS(*pte);
80106cb0:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106cb6:	89 75 e4             	mov    %esi,-0x1c(%ebp)
        pa = PTE_ADDR(*pte);
80106cb9:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
        if((mem = kalloc()) == 0)
80106cbf:	e8 cc b7 ff ff       	call   80102490 <kalloc>
80106cc4:	85 c0                	test   %eax,%eax
80106cc6:	89 c6                	mov    %eax,%esi
80106cc8:	0f 85 62 ff ff ff    	jne    80106c30 <copyuvm+0x100>
80106cce:	e9 20 ff ff ff       	jmp    80106bf3 <copyuvm+0xc3>
80106cd3:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106cd6:	83 c4 2c             	add    $0x2c,%esp
80106cd9:	5b                   	pop    %ebx
80106cda:	5e                   	pop    %esi
80106cdb:	5f                   	pop    %edi
80106cdc:	5d                   	pop    %ebp
80106cdd:	c3                   	ret    
    return 0;
80106cde:	31 c0                	xor    %eax,%eax
80106ce0:	e9 1b ff ff ff       	jmp    80106c00 <copyuvm+0xd0>
      panic("copyuvm: page not present");
80106ce5:	c7 04 24 c2 78 10 80 	movl   $0x801078c2,(%esp)
80106cec:	e8 6f 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106cf1:	c7 04 24 a8 78 10 80 	movl   $0x801078a8,(%esp)
...
80106d0e:	e8 ad f6 ff ff       	call   801063c0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d7c:	e8 8f d5 ff ff       	call   80104310 <memmove>
    len -= n;
    buf += n;
...
80106dd6:	c7 44 24 04 00 79 10 	movl   $0x80107900,0x4(%esp)
80106ddd:	80 
80106dde:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106de5:	e8 56 d2 ff ff       	call   80104040 <initlock>
  acquire(&(shm_table.lock));
80106dea:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106df1:	e8 3a d3 ff ff       	call   80104130 <acquire>
...
80106e25:	e8 f6 d3 ff ff       	call   80104220 <release>
}
80106e2a:	c9                   	leave  
80106e2b:	c3                   	ret    
